...
function ExpSignUp() {
    ...
    const handleSubmit = async (e) => {
        ...
        setError('');
        try {
            await axios.post("http://localhost:3001/api/auth/expsignup", { username, email, password });
            navigate("/explogin");
        } catch (e) {
            ...
            <div id="block">
                <div id="login" style={bk}>
                    ...
                    <div id="inLogin">
                        ...
                        <p>Already have an account? <b><Link to="/explogin">Login</Link></b></p>
                    </div>
                </div>
            </div>
        </>
